...
map.getView().fit([19644314.762208, -4836851.375908, 19731405.159141, -4785351.263895], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Fruitcraft NZ</h2>';
        return titleElement;
    })(),
